...
--- START OF FILE examples/azure-openai/fastagent.config.yaml ---
...
--- END OF FILE examples/azure-openai/fastagent.config.yaml ---


--- START OF FILE examples/bedrock/fast-agent.config.yaml ---
...
--- END OF FILE examples/bedrock/fast-agent.config.yaml ---


--- START OF FILE examples/custom-agents/agent.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/custom-agents/agent.py ---


--- START OF FILE examples/custom-agents/fastagent.config.yaml ---
...
--- END OF FILE examples/custom-agents/fastagent.config.yaml ---


--- START OF FILE examples/data-analysis/analysis-campaign.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/data-analysis/analysis-campaign.py ---


--- START OF FILE examples/data-analysis/analysis.py ---
import asyncio
...
#     min_rating="EXCELLENT",
# )
--- END OF FILE examples/data-analysis/analysis.py ---


--- START OF FILE examples/data-analysis/fastagent.config.yaml ---
...
--- END OF FILE examples/data-analysis/fastagent.config.yaml ---


--- START OF FILE examples/otel/agent.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/otel/agent.py ---


--- START OF FILE examples/otel/agent2.py ---
import asyncio
from typing import Annotated
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/otel/agent2.py ---


--- START OF FILE examples/otel/docker-compose.yaml ---
services:
  jaeger:
...
--- END OF FILE examples/otel/docker-compose.yaml ---


--- START OF FILE examples/otel/fastagent.config.yaml ---
...
--- END OF FILE examples/otel/fastagent.config.yaml ---


--- START OF FILE examples/researcher/fastagent.config.yaml ---
#
# Please edit this configuration file to match your environment (on Windows).
# Examples in comments below - check/change the paths.
#
...
--- END OF FILE examples/researcher/fastagent.config.yaml ---


--- START OF FILE examples/researcher/researcher-eval.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/researcher/researcher-eval.py ---


--- START OF FILE examples/researcher/researcher-imp.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/researcher/researcher-imp.py ---


--- START OF FILE examples/researcher/researcher.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/researcher/researcher.py ---


--- START OF FILE examples/tensorzero/.env.sample ---
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
--- END OF FILE examples/tensorzero/.env.sample ---


--- START OF FILE examples/tensorzero/agent.py ---
import asyncio
...
--- END OF FILE examples/tensorzero/agent.py ---


--- START OF FILE examples/tensorzero/docker-compose.yml ---
...
services:
  ...
  minio:
    ...
    healthcheck:
      ...
      timeout: 20s
      retries: 3
--- END OF FILE examples/tensorzero/docker-compose.yml ---


--- START OF FILE examples/tensorzero/fastagent.config.yaml ---
default_model: haiku
...
--- END OF FILE examples/tensorzero/fastagent.config.yaml ---


--- START OF FILE examples/tensorzero/image_demo.py ---
import asyncio
import base64
import mimetypes
...
if __name__ == "__main__":
    asyncio.run(main())  # type: ignore
--- END OF FILE examples/tensorzero/image_demo.py ---


--- START OF FILE examples/tensorzero/Makefile ---
.PHONY: all
...
--- END OF FILE examples/tensorzero/Makefile ---


--- START OF FILE examples/tensorzero/README.md ---
...
--- END OF FILE examples/tensorzero/README.md ---


--- START OF FILE examples/tensorzero/simple_agent.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())  # type: ignore
--- END OF FILE examples/tensorzero/simple_agent.py ---


--- START OF FILE examples/workflows/chaining.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/workflows/chaining.py ---


--- START OF FILE examples/workflows/evaluator.py ---
"""
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/workflows/evaluator.py ---


--- START OF FILE examples/workflows/fastagent.config.yaml ---
# Please edit this configuration file to match your environment (on Windows).
# Examples in comments below - check/change the paths.
#
#
...
mcp:
  servers:
    ...
    fetch:
      command: "uvx"
      args: ["mcp-server-fetch"]
--- END OF FILE examples/workflows/fastagent.config.yaml ---


--- START OF FILE examples/workflows/graded_report.md ---
...
--- END OF FILE examples/workflows/graded_report.md ---


--- START OF FILE examples/workflows/human_input.py ---
"""
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/workflows/human_input.py ---


--- START OF FILE examples/workflows/orchestrator.py ---
"""
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/workflows/orchestrator.py ---


--- START OF FILE examples/workflows/parallel.py ---
"""
...
if __name__ == "__main__":
    asyncio.run(main())  # type: ignore
--- END OF FILE examples/workflows/parallel.py ---


--- START OF FILE examples/workflows/router.py ---
"""
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/workflows/router.py ---


--- START OF FILE examples/workflows/short_story.md ---
...
THE END??
--- END OF FILE examples/workflows/short_story.md ---


--- START OF FILE examples/workflows/short_story.txt ---
...
--- END OF FILE examples/workflows/short_story.txt ---


--- START OF FILE examples/tensorzero/mcp_server/Dockerfile ---
...
--- END OF FILE examples/tensorzero/mcp_server/Dockerfile ---


--- START OF FILE examples/tensorzero/mcp_server/entrypoint.sh ---
#!/bin/sh
...
exec "$@"
--- END OF FILE examples/tensorzero/mcp_server/entrypoint.sh ---


--- START OF FILE examples/tensorzero/mcp_server/mcp_server.py ---
import uvicorn
...
--- END OF FILE examples/tensorzero/mcp_server/mcp_server.py ---


--- START OF FILE examples/tensorzero/tensorzero_config/system_schema.json ---
{
...
--- END OF FILE examples/tensorzero/tensorzero_config/system_schema.json ---


--- START OF FILE examples/tensorzero/tensorzero_config/system_template.minijinja ---
...
{{ TEST_VARIABLE_4 }}
--- END OF FILE examples/tensorzero/tensorzero_config/system_template.minijinja ---


--- START OF FILE examples/tensorzero/tensorzero_config/tensorzero.toml ---
[functions.test_chat]
type = "chat"
...
allow_http = true
--- END OF FILE examples/tensorzero/tensorzero_config/tensorzero.toml ---


--- START OF FILE examples/mcp/elicitations/elicitation_account_server.py ---
"""
...
if __name__ == "__main__":
    ...
    mcp.run()
--- END OF FILE examples/mcp/elicitations/elicitation_account_server.py ---


--- START OF FILE examples/mcp/elicitations/elicitation_forms_server.py ---
"""
...
if __name__ == "__main__":
    ...
    mcp.run()
--- END OF FILE examples/mcp/elicitations/elicitation_forms_server.py ---


--- START OF FILE examples/mcp/elicitations/elicitation_game_server.py ---
"""
...
if __name__ == "__main__":
    ...
    mcp.run()
--- END OF FILE examples/mcp/elicitations/elicitation_game_server.py ---


--- START OF FILE examples/mcp/elicitations/fastagent.config.yaml ---
...
mcp:
  servers:
    ...
    elicitation_game_server:
      ...
      elicitation:
        mode: "forms"
--- END OF FILE examples/mcp/elicitations/fastagent.config.yaml ---


--- START OF FILE examples/mcp/elicitations/fastagent.secrets.yaml.example ---
...
# groq_api_key: "..."
# mistral_api_key: "..."
--- END OF FILE examples/mcp/elicitations/fastagent.secrets.yaml.example ---


--- START OF FILE examples/mcp/elicitations/forms_demo.py ---
"""
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/elicitations/forms_demo.py ---


--- START OF FILE examples/mcp/elicitations/game_character.py ---
#!/usr/bin/env python3
"""
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/elicitations/game_character.py ---


--- START OF FILE examples/mcp/elicitations/game_character_handler.py ---
"""
...
async def game_character_elicitation_handler(
    ...
    if params.requestedSchema:
        ...
        return ElicitResult(action="accept", content=content)
--- END OF FILE examples/mcp/elicitations/game_character_handler.py ---


--- START OF FILE examples/mcp/elicitations/tool_call.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/elicitations/tool_call.py ---


--- START OF FILE examples/mcp/mcp-filtering/fastagent.config.yaml ---
mcp:
  servers:
...
--- END OF FILE examples/mcp/mcp-filtering/fastagent.config.yaml ---


--- START OF FILE examples/mcp/mcp-filtering/fastagent.secrets.yaml.example ---
...
--- END OF FILE examples/mcp/mcp-filtering/fastagent.secrets.yaml.example ---


--- START OF FILE examples/mcp/mcp-filtering/mcp_server.py ---
import random
import string
...
if __name__ == "__main__":
    # Run in stdio mode
    app.run()
--- END OF FILE examples/mcp/mcp-filtering/mcp_server.py ---


--- START OF FILE examples/mcp/mcp-filtering/test_mcp_filtering.py ---
import asyncio
import sys
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/mcp-filtering/test_mcp_filtering.py ---


--- START OF FILE examples/mcp/state-transfer/agent_one.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/state-transfer/agent_one.py ---


--- START OF FILE examples/mcp/state-transfer/agent_two.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/state-transfer/agent_two.py ---


--- START OF FILE examples/mcp/state-transfer/fastagent.config.yaml ---
# Model string takes format:
#   <provider>.<model_string>.<reasoning_effort?> (e.g. anthropic.claude-3-5-sonnet-20241022 or openai.o3-mini.low)
#
# Can be overriden with a command line switch --model=<model>, or within the Agent decorator.
...
--- END OF FILE examples/mcp/state-transfer/fastagent.config.yaml ---


--- START OF FILE examples/mcp/state-transfer/fastagent.secrets.yaml.example ---
# FastAgent Secrets Configuration
# WARNING: Keep this file secure and never commit to version control
...
openrouter:
  api_key: <your-api-key-here>
--- END OF FILE examples/mcp/state-transfer/fastagent.secrets.yaml.example ---


--- START OF FILE examples/mcp/vision-examples/example1.py ---
import asyncio
from pathlib import Path
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/vision-examples/example1.py ---


--- START OF FILE examples/mcp/vision-examples/example2.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/vision-examples/example2.py ---


--- START OF FILE examples/mcp/vision-examples/example3.py ---
import asyncio
...
if __name__ == "__main__":
    asyncio.run(main())
--- END OF FILE examples/mcp/vision-examples/example3.py ---


--- START OF FILE examples/mcp/vision-examples/fastagent.config.yaml ---
# FastAgent Configuration File
...
--- END OF FILE examples/mcp/vision-examples/fastagent.config.yaml ---
